      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-10 text-center">
        <Reveal>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <Link
              to="/signup"
              className="font-body font-semibold text-white bg-navy hover:bg-blue px-9 py-4 rounded-lg transition-colors text-lg"
            >
              Sign up free
            </Link>
            <Link
              to="/login"
              className="font-body font-semibold text-navy border border-navy/20 hover:border-navy/40 px-9 py-4 rounded-lg transition-colors text-lg"
            >
              Sign in
            </Link>
          </div>
